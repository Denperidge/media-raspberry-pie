...
py -3 $transcoder_path/process.py "$transcoder_path/repo/" "$media_path/transcoded/sonarr/" sonarr

py -3 $transcoder_path/repo/manual.py -i //$pie_ip/to-transcode/radarr/ -m //$pie_ip/transcoded/radarr/ --auto
py -3 $transcoder_path/process.py "$transcoder_path/repo/" "$media_path/transcoded/radarr/" radarr
